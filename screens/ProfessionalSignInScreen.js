...
const ProfessionalSignInScreen = props => {
      ...
      >
          ...
          style={StyleSheet.applyWidth(
            {
              ...
              width: [
                ...
                { minWidth: Breakpoints.Tablet, value: '75%' },
              ],
            },
            dimensions.width
          )}
              ...
              style={StyleSheet.applyWidth(
                {
                  ...
                  color: {
                    minWidth: Breakpoints.Tablet,
                    value: palettes.Brand.Community_Dark_UI,
                  },
        ...
        <View style={StyleSheet.applyWidth({ width: 160 }, dimensions.width)}>
          <CheckboxRow
            ...
            style={StyleSheet.applyWidth(
              {
                fontSize: { minWidth: Breakpoints.Tablet, value: 14 },
                minHeight: 50,
              },
              dimensions.width
            )}
              ...
              try {
                ...
                if (check === compValue) {
                  ...
                  if (authProfRecord?.length === incorrect_login) {
                    const valueZiKa3EmN = 'incorrect username or Password';
                    setError(valueZiKa3EmN);
                    const error = valueZiKa3EmN;
                  }
                  ...
                  navigation.replace('ProfprofileScreen');
                }
              ...
              <Icon
                ...
                color={StyleSheet.getWidthValue(
                  [
                    {
                      minWidth: Breakpoints.Tablet,
                      value: palettes.Brand.Community_Primary_Alt,
                    },
                    {
                      minWidth: Breakpoints.Mobile,
                      value: palettes.Brand.Community_Primary_Alt,
        ...
        <Touchable
          onPress={() => {
            try {
              ...
              navigation.replace('ProfessionalSignUpScreen');
            } catch (err) {
              console.error(err);
            }
          }}
...
export default withTheme(ProfessionalSignInScreen);
